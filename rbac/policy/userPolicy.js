...
const { GET_USER, UPDATE_PROFILE, RESERT_PASSWORD, ADD_EVENT_ID, ADD_HOTEL_ID, ADD_RES_ID, ADD_VISITPLACE_ID, UPLOAD_IMAGE_PROFILE } = require("../../modules/users/endPoint");
const { getall_Vplace, Add_reserve_Place } = require("../../modules/visitplace/endpoint");
