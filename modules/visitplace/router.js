...
const { GET_Vplace, undelete_Vplace, getall_Vplace, add_Vplace, update_Vplace, delete_Vplace, getSoftDelete_Vplace, softdelete_Vplace, Add_reserve_Place } = require("./endpoint");
const uploadImage = require("../../config/upload");
const { reserveVisitPlace } = require("./reserve.controller");
...
visitRouts.post("/reserveVisitPlace",isAuthoraized(Add_reserve_Place) ,reserveVisitPlace)
visitRouts.put("/setRateVisitPlace/:id", setRateVisitPlace)
